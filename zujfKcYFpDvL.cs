...
public class GorillaHatButtonParent : MonoBehaviourPunCallbacks, IInRoomCallbacks
{
	...
	public void Start()
	{
		...
		badge = PlayerPrefs.GetString("badgeCosmetic", "none");
                hand = PlayerPrefs.GetString("handCosmetic", "none");
    }
	...
	public void PressButton(bool isOn, GorillaHatButton.HatButtonType buttonType, string buttonValue)
	{
		...
		case GorillaHatButton.HatButtonType.Hat:
			...
			break;
        case GorillaHatButton.HatButtonType.Hand:
                if (hand != buttonValue)
                {
                    hand = buttonValue;
                    PlayerPrefs.SetString("handCosmetic", buttonValue);
                }
                else
                {
                    hand = "none";
                    PlayerPrefs.SetString("handCosmetic", "none");
                }
                break;
        }
		PlayerPrefs.Save();
	...
	private void UpdateButtonState()
	{
		...
		foreach (GorillaHatButton gorillaHatButton in array)
		{
			...
			case GorillaHatButton.HatButtonType.Badge:
				...
				break;
            case GorillaHatButton.HatButtonType.Hand:
                gorillaHatButton.isOn = gorillaHatButton.cosmeticName == hand;
                break;
            }
		...
		{
			GorillaTagger.Instance.offlineVRRig.LocalUpdateCosmetics(badge, hand, face, hat);
		}
		if (GorillaTagger.Instance.myVRRig != null)
		{
			GorillaTagger.Instance.myVRRig.photonView.RPC("UpdateCosmetics", RpcTarget.All, badge, hand, face, hat);
		}
	}
}
