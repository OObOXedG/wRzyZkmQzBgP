...
// VRRig
using System; // BY SONOTCLOSE (.gg/zenunity)
using GorillaLocomotion; // BY SONOTCLOSE (.gg/zenunity)
using GorillaNetworking; // BY SONOTCLOSE (.gg/zenunity)
using Photon.Pun; // BY SONOTCLOSE (.gg/zenunity)
using Photon.Realtime; // BY SONOTCLOSE (.gg/zenunity)
using Photon.Voice.PUN; // BY SONOTCLOSE (.gg/zenunity)
using Photon.Voice.Unity; // BY SONOTCLOSE (.gg/zenunity)
using PlayFab; // BY SONOTCLOSE (.gg/zenunity)
using PlayFab.ClientModels; // BY SONOTCLOSE (.gg/zenunity)
using UnityEngine; // BY SONOTCLOSE (.gg/zenunity)
using UnityEngine.UI; // BY SONOTCLOSE (.gg/zenunity)
using UnityEngine.XR; // BY SONOTCLOSE (.gg/zenunity)

public class VRRig : MonoBehaviourPun, IPunObservable, IPunInstantiateMagicCallback // BY SONOTCLOSE (.gg/zenunity)
{
	public VRMap head; // BY SONOTCLOSE (.gg/zenunity)

	public VRMap rightHand; // BY SONOTCLOSE (.gg/zenunity)

	public VRMap leftHand; // BY SONOTCLOSE (.gg/zenunity)

	public VRMapThumb leftThumb; // BY SONOTCLOSE (.gg/zenunity)

	public VRMapIndex leftIndex; // BY SONOTCLOSE (.gg/zenunity)

	public VRMapMiddle leftMiddle; // BY SONOTCLOSE (.gg/zenunity)

	public VRMapThumb rightThumb; // BY SONOTCLOSE (.gg/zenunity)

	public VRMapIndex rightIndex; // BY SONOTCLOSE (.gg/zenunity)

	public VRMapMiddle rightMiddle; // BY SONOTCLOSE (.gg/zenunity)

	public bool isOfflineVRRig; // BY SONOTCLOSE (.gg/zenunity)

	public GameObject mainCamera; // BY SONOTCLOSE (.gg/zenunity)

	public Transform playerOffsetTransform; // BY SONOTCLOSE (.gg/zenunity)

	public int SDKIndex; // BY SONOTCLOSE (.gg/zenunity)

	public bool isMyPlayer; // BY SONOTCLOSE (.gg/zenunity)

	public AudioSource leftHandPlayer; // BY SONOTCLOSE (.gg/zenunity)

	public AudioSource rightHandPlayer; // BY SONOTCLOSE (.gg/zenunity)

	public AudioSource tagSound; // BY SONOTCLOSE (.gg/zenunity)

	[SerializeField]
	private float ratio; // BY SONOTCLOSE (.gg/zenunity)

	public Transform headConstraint; // BY SONOTCLOSE (.gg/zenunity)

	public Vector3 headBodyOffset; // BY SONOTCLOSE (.gg/zenunity)

	public GameObject headMesh; // BY SONOTCLOSE (.gg/zenunity)

	public Vector3 syncPos; // BY SONOTCLOSE (.gg/zenunity)

	public Quaternion syncRotation; // BY SONOTCLOSE (.gg/zenunity)

	public AudioClip[] clipToPlay; // BY SONOTCLOSE (.gg/zenunity)

	public AudioClip[] handTapSound; // BY SONOTCLOSE (.gg/zenunity)

	public int currentMatIndex; // BY SONOTCLOSE (.gg/zenunity)

	public int setMatIndex; // BY SONOTCLOSE (.gg/zenunity)

	private int tempMatIndex; // BY SONOTCLOSE (.gg/zenunity)

	public float lerpValueFingers; // BY SONOTCLOSE (.gg/zenunity)

	public float lerpValueBody; // BY SONOTCLOSE (.gg/zenunity)

	public GameObject backpack; // BY SONOTCLOSE (.gg/zenunity)

	public Transform leftHandTransform; // BY SONOTCLOSE (.gg/zenunity)

	public Transform rightHandTransform; // BY SONOTCLOSE (.gg/zenunity)

	public SkinnedMeshRenderer mainSkin; // BY SONOTCLOSE (.gg/zenunity)

	public Photon.Realtime.Player myPlayer; // BY SONOTCLOSE (.gg/zenunity)

	public GameObject spectatorSkin; // BY SONOTCLOSE (.gg/zenunity)

	public int handSync; // BY SONOTCLOSE (.gg/zenunity)

	public Material[] materialsToChangeTo; // BY SONOTCLOSE (.gg/zenunity)

	public float red; // BY SONOTCLOSE (.gg/zenunity)

	public float green; // BY SONOTCLOSE (.gg/zenunity)

	public float blue; // BY SONOTCLOSE (.gg/zenunity)

	public string playerName; // BY SONOTCLOSE (.gg/zenunity)

	public Text playerText; // BY SONOTCLOSE (.gg/zenunity)

	public bool showName; // BY SONOTCLOSE (.gg/zenunity)

	public GameObject[] cosmetics; // BY SONOTCLOSE (.gg/zenunity)

	public string concatStringOfCosmeticsAllowed = ""; // BY SONOTCLOSE (.gg/zenunity)

	public bool initializedCosmetics; // BY SONOTCLOSE (.gg/zenunity)

  public string hand; // BY SONOTCLOSE (.gg/zenunity)

  public string badge; // BY SONOTCLOSE (.gg/zenunity)

	public string face; // BY SONOTCLOSE (.gg/zenunity)

	public string hat; // BY SONOTCLOSE (.gg/zenunity)

  public string tryOnRoomHand = "NOTHING"; // BY SONOTCLOSE (.gg/zenunity)

  public string tryOnRoomBadge = "NOTHING"; // BY SONOTCLOSE (.gg/zenunity)

	public string tryOnRoomFace = "NOTHING"; // BY SONOTCLOSE (.gg/zenunity)

	public string tryOnRoomHat = "NOTHING"; // BY SONOTCLOSE (.gg/zenunity)

	public bool inTryOnRoom; // BY SONOTCLOSE (.gg/zenunity)

	public bool muted; // BY SONOTCLOSE (.gg/zenunity)

	private float timeSpawned; // BY SONOTCLOSE (.gg/zenunity)

	public float doNotLerpConstant = 1f; // BY SONOTCLOSE (.gg/zenunity)

	public string tempString; // BY SONOTCLOSE (.gg/zenunity)

	private Photon.Realtime.Player tempPlayer; // BY SONOTCLOSE (.gg/zenunity)

	private float[] speedArray; // BY SONOTCLOSE (.gg/zenunity)

	public ParticleSystem lavaParticleSystem; // BY SONOTCLOSE (.gg/zenunity)

	public ParticleSystem rockParticleSystem; // BY SONOTCLOSE (.gg/zenunity)

	public ParticleSystem iceParticleSystem; // BY SONOTCLOSE (.gg/zenunity)

	public string tempItemName; // BY SONOTCLOSE (.gg/zenunity)

	public CosmeticsController.CosmeticItem tempItem; // BY SONOTCLOSE (.gg/zenunity)

	public string tempItemId; // BY SONOTCLOSE (.gg/zenunity)

	public int tempItemCost; // BY SONOTCLOSE (.gg/zenunity)

	public float bonkTime; // BY SONOTCLOSE (.gg/zenunity)

	public float bonkCooldown = 2f; // BY SONOTCLOSE (.gg/zenunity)

	public bool isQuitting; // BY SONOTCLOSE (.gg/zenunity)

	public GameObject huntComputer; // BY SONOTCLOSE (.gg/zenunity)

	public bool kickMe; // BY SONOTCLOSE (.gg/zenunity)
	...
	private void Start()
	{
		...
		{ //from here down
            ...
            badge = PlayerPrefs.GetString("handCosmetic", "NOTHING");
		...
		else if (isOfflineVRRig)
		{
			...
			badge = PlayerPrefs.GetString("badgeCosmetic", "NOTHING");
			face = PlayerPrefs.GetString("faceCosmetic", "NOTHING");
            hand = PlayerPrefs.GetString("handCosmetic", "NOTHING");
            if (Application.platform == RuntimePlatform.Android && spectatorSkin != null)
			{
				UnityEngine.Object.Destroy(spectatorSkin);
			}
	...
	[PunRPC]
	public void UpdateCosmetics(string newBadge, string newFace, string newHand, string newHat, PhotonMessageInfo info)
	{
		if (info.Sender == base.photonView.Owner)
		{
			LocalUpdateCosmetics(newBadge, newFace, newHand, newHat);
		}
	}

	[PunRPC]
	public void UpdateCosmeticsWithTryon(string newBadge, string newFace, string newHand, string newHat, string tryOnBadge, string tryOnFace, string tryOnHand, string tryOnHat, PhotonMessageInfo info)
	{
		if (info.Sender == base.photonView.Owner)
		{
			LocalUpdateCosmeticsWithTryon(newBadge, newFace, newHat, newHand, tryOnBadge, tryOnFace, tryOnHand, tryOnHat);
		}
	}
	...
	public void LocalUpdateCosmetics(string newBadge, string newFace, string newHand, string newHat)
	{
        hand = newHand;
        badge = newBadge;
		face = newFace;
	...
	public void LocalUpdateCosmeticsWithTryon(string newBadge, string newFace, string newHand, string newHat, string tryOnBadge, string tryOnFace, string tryOnHand, string tryOnHat)
	{
        hand = newHand;
        badge = newBadge;
		face = newFace;
		hat = newHat;
        tryOnRoomHand = tryOnHand;
	...
	public void SetCosmeticsActive()
	{
		...
		foreach (GameObject gameObject in array)
		{
			if (!inTryOnRoom)
			{
				...
				{
					gameObject.SetActive(gameObject.name == badge || gameObject.name == face || gameObject.name == hand || gameObject.name == hat);
				}
				else
				{
			...
			else if ((gameObject.name == tryOnRoomBadge || gameObject.name == tryOnRoomFace || gameObject.name == tryOnRoomHand || gameObject.name == tryOnRoomHat) && CosmeticsController.instance.GetItemFromDict(CosmeticsController.instance.GetItemNameFromDisplayName(gameObject.name)).canTryOn)
			{
			...
			{
				gameObject.SetActive((gameObject.name == badge && tryOnRoomBadge == "NOTHING") || (gameObject.name == face && tryOnRoomFace == "NOTHING") || (gameObject.name == hand && tryOnRoomHand == "NOTHING") || (gameObject.name == hat && tryOnRoomHat == "NOTHING"));
			}
			else
			{
				gameObject.SetActive(value: false);
